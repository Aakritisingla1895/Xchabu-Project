...
# bedroom
pygame.draw.rect(DISPLAY, WHITE, (x+bedw-55, y + util+bedl-8, roomdoor, pt2+pt2))
pygame.draw.rect(DISPLAY, Black, (x+bedw-55, y + util+bedl-8, 2, pt1))
pygame.draw.rect(DISPLAY, Black, (x+bedw-55+roomdoor, y + util+bedl-8, 2, pt1))
# drawing
pygame.draw.rect(DISPLAY, WHITE, (x + staw+2, y + util + bedl+dral-pt1+3, entdoor, pt1+pt2))
pygame.draw.rect(DISPLAY, Black, (x + staw+entdoor, y + util + bedl+dral-pt1+3, 2, pt1))
...
pygame.draw.rect(DISPLAY, Black, (x+pt1+ kitw-pt1-pt1-1, y + util + bedl + stal-2,2, pt1))
# store
pygame.draw.rect(DISPLAY, WHITE, (x + washw+pt1-2, y + util + bedl + stal - washl-50+washl-8, roomdoor, pt1))
