...
# wash
pygame.draw.rect(DISPLAY, WHITE, (x+pt1+2, y + util + bedl + stal - washl-50+washl-pt2-2, toidoor, pt1))
pygame.draw.rect(DISPLAY, Black, (x+pt1+2+toidoor, y + util + bedl + stal - washl-50+washl-pt2-2, 2, pt1))
# store
pygame.draw.rect(DISPLAY, WHITE, (x + washw+pt1-1, y + util + bedl + stal - washl-50+washl-2, 40, pt1))
# bedroom
pygame.draw.rect(DISPLAY, WHITE, (x+bedw-22, y + util+bedl-2, 33, pt2))
# drawing
...
# toilet
pygame.draw.rect(DISPLAY, WHITE, (x + utiw-pt1+23, y+toil-roomdoor, pt1, roomdoor))
pygame.draw.rect(DISPLAY, Black, (x + utiw-pt1+23, y+toil-roomdoor, pt1, 3))
pygame.draw.rect(DISPLAY, Black, (x + utiw-pt1+23, y+toil-2, pt1, 3))
# c.toilet
pygame.draw.rect(DISPLAY, WHITE, (x + bedw+2*pt1+1, y + toil+col-pt1+3, toidoor, pt1))
pygame.draw.rect(DISPLAY, Black, (x + bedw+12, y + toil+col-pt1+3, pt1, 2))
pygame.draw.rect(DISPLAY, Black, (x + bedw+2*pt1+1+toidoor, y + toil+col-pt1+3, 2.5, pt1))
# kitchen
