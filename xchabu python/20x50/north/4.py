...
foyer= font.render('Wash area', True, Black)
DISPLAY.blit(foyer, (otsx, otsy))
# inner wall
pygame.draw.rect(DISPLAY, (0, 0,0), (x+pt1 , y +pt1, otsw-pt1, otsl-pt1), 2)
#toilet:-
toil = len * 0.1
toiw = wid * 0.48
toix = x +otsw+ toiw / 2
...
# inner toilet
pygame.draw.rect(DISPLAY, (0, 0,0), (x+otsw-1+pt2 , y+pt1, toiw-pt1-pt2, toil-pt1), 2)
#kitchen:-
kitl = len * 0.2
kitw = wid * 0.40
kitx = x + kitw / 3
...
# kitchen
pygame.draw.rect(DISPLAY, WHITE, (x+kitw-47, y+otsl- 2, roomdoor, 2*pt1))
