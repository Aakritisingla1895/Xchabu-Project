...
pygame.init()
DISPLAY = pygame.display.set_mode((1200,850),0,32)
WHITE = (255,255,255)
Black = (0,0,0)
blue = (0,0,255)
DISPLAY.fill(WHITE)
...
pygame.draw.rect(DISPLAY, Black, (x + staw + dinw-1+pt2+1, y + toil + bedl-1, 2,pt1-1 ))
pygame.draw.rect(DISPLAY, Black, (x + staw + dinw-1+pt2+roomdoor, y + toil + bedl-1, 2,pt1-1 ))
# toilet 2
...
# kitchen
pygame.draw.rect(DISPLAY, WHITE, (x+bedw+pt2, y+otsl+kitl-1, 37, pt1))
