...
# inner dining
pygame.draw.rect(DISPLAY, (0, 0,0), (x+staw,y+bedl+otsl-1+pt2 , dinw, dinl-pt2), 2)
#c.toilet:-
col = len * 0.08
cow = wid * 0.2
cox = x +staw+dinw + cow / 3-10
coy = y +toil+bedl + col / 2
pygame.draw.rect(DISPLAY, (0, 0,0), (x+staw+dinw-1 , y+toil+bedl-1 , cow, col), 2)
ctoilet = font.render('store', True, Black)
DISPLAY.blit(ctoilet, (cox, coy))
# inner toielt
pygame.draw.rect(DISPLAY, (0, 0,0), (x+staw+dinw-1+pt2, y+toil+bedl-1+pt2 , cow-pt2-pt1, col-pt2), 2)
##wash area:-
washl = len * 0.08
washw = wid * 0.2
washx = x+staw+dinw + washw / 3-10
washy = y +otsl+bedl+ col + washl / 2
pygame.draw.rect(DISPLAY, (0, 0,0), (x+staw+dinw-1, y+otsl+bedl+ col-1 , washw, washl), 2)
wash = font.render('Wash', True, Black)
DISPLAY.blit(wash, (washx, washy))
# inner wash
pygame.draw.rect(DISPLAY, (0, 0,0), (x+staw+dinw+pt2, y+otsl+bedl+ col+pt2 , washw-pt2-pt1, washl-pt2-1), 2)
# drawing room
drawl = len * 0.2
draww = wid * 0.48
drawx = x  + draww / 3
...
# door
# kitchen correction
pygame.draw.rect(DISPLAY, WHITE, (x+draww+2, y+otsl+bedl+toil+washl+2 , kitw-2, kitl-2))
pygame.draw.rect(DISPLAY, (0, 0,0), (x+draww-1, y+otsl+bedl+toil+washl-1 , kitw, kitl), 2)
Kitcehn = font.render('Kitchen', True, Black)
DISPLAY.blit(Kitcehn, (kitx, kity))
# inner kitchen
...
# wash
pygame.draw.rect(DISPLAY, WHITE, (x+staw+dinw-2, y+otsl+bedl+ col+pt2 , pt1, roomdoor))
pygame.draw.rect(DISPLAY, Black, (x+staw+dinw-2, y+otsl+bedl+ col+pt2 , pt1, 2))
pygame.draw.rect(DISPLAY, Black, (x+staw+dinw-2, y+otsl+bedl+ col+pt2+roomdoor , pt1, 2))
pygame.draw.rect(DISPLAY, Black, (x+staw+dinw-2, y+otsl+bedl+ col+pt2+roomdoor+pt2 , 2, pt1))
# c.toilet
pygame.draw.rect(DISPLAY, WHITE, (x+staw+dinw-2 , y+toil+bedl-1+pt1 , pt1, toidoor))
pygame.draw.rect(DISPLAY, Black, (x+staw+dinw-1 , y+toil+bedl-1+pt1 , pt1-2, 2))
pygame.draw.rect(DISPLAY, Black, (x+staw+dinw-1 , y+toil+bedl-1+pt1+toidoor , pt1-2, 2))
# bedroom 2
...
pygame.draw.rect(DISPLAY, Black, (x+bedw-roomdoor, y+otsl-2+bedl , 2, pt1))
pygame.draw.rect(DISPLAY, Black, (x+bedw, y+otsl-2+bedl , 2, pt1))
# toilet
