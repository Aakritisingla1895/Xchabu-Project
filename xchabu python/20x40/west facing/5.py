...
# inner bedroom
pygame.draw.rect(DISPLAY, (0, 0,0), (x+bedw-1+pt2, y+pt1 , washw-pt2, washl-pt1+1), 2)
#wash area:-
washl = len * 0.125
washw = wid * 0.25
washx = x +bedw++washw+ washw / 3
washy = y + washl / 2
pygame.draw.rect(DISPLAY, (0, 0,0), (x+bedw-1+washw-1, y , washw, washl), 2)
wash = font.render('store', True, Black)
DISPLAY.blit(wash, (washx, washy))
# inner store
pygame.draw.rect(DISPLAY, (0, 0,0), (x+bedw-1+washw-1+pt2, y+pt1 , washw-pt2-pt1, washl-pt1+1), 2)
#kitchen:-
kitl = len * 0.25
kitw = wid * 0.5
kitx = x+bedw + kitw / 3
...
# store
pygame.draw.rect(DISPLAY, WHITE, (x+bedw+washw+pt2, y+washl-1 , roomdoor, pt1))
pygame.draw.rect(DISPLAY, Black, (x+bedw+washw+pt2-1, y+washl-1 , 2, pt1-2))
pygame.draw.rect(DISPLAY, Black, (x+bedw+washw+pt2+roomdoor, y+washl-1 , 2, pt1-2))
