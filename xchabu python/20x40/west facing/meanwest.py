...
entw = wid * 0.375
entx = x  + entw / 2
enty = y + otsl + bedl + stal + entl / 2
pygame.draw.rect(DISPLAY, (0, 0,0), (x , y + otsl + bedl + stal-1  , entw, entl), 2)
ent= font.render('Entry', True, Black)
DISPLAY.blit(ent, (entx, enty))
# inner entry
pygame.draw.rect(DISPLAY, (0, 0,0), (x , y + otsl + bedl + stal-1 +pt1 , entw, entl-pt1), 2)
# foyer
foyl= len*0.125
foyw = wid*0.25
foyx=x +foyw/2+5
foyy=y + otsl + bedl + stal-1 +foyl/2
pygame.draw.rect(DISPLAY, (0, 0,0), (x+entw-foyw ,  y + otsl + bedl + stal-1, foyw, foyl), 2)
...
pygame.draw.rect(DISPLAY, (0, 0,0), (x+entw -1, y+ otsl + bedl + stal-1 , draww, drawl), 2)
draw= font.render('Drawing', True, Black)
DISPLAY.blit(draw, (drawx, drawy))  
# inner drawing
pygame.draw.rect(DISPLAY, (0, 0,0), (x+entw+pt1, y+ otsl + bedl + stal+pt2 , draww-pt1-pt1, drawl-pt2-pt1), 2)
# garden
garl = len * 0.125
garw = wid * 0.625
garx = x +entw+ garw / 3
gary = y+ otsl + bedl + stal+drawl + garl / 2
pygame.draw.rect(DISPLAY, (0, 0,0), (x+entw-1, y+ otsl + bedl + stal+drawl-1 , garw, garl), 2)
...
#  main entrance
pygame.draw.rect(DISPLAY, WHITE, (x+entw-entdoor-1 , y + otsl + bedl + stal-2  , entdoor, pt1+pt2))
pygame.draw.rect(DISPLAY, Black, (x+entw-entdoor-1 , y + otsl + bedl + stal-2  , 2, pt1+pt2-3))
# dining to drawing
pygame.draw.rect(DISPLAY, WHITE, (x+entw -1+pt1+30, y+ otsl + bedl + stal-2 , roomdoor, pt1))
pygame.draw.rect(DISPLAY, Black, (x+entw -1+pt1+30, y+ otsl + bedl + stal-2 , 2, pt1))
pygame.draw.rect(DISPLAY, Black, (x+entw -1+pt1+30+roomdoor, y+ otsl + bedl + stal-2 , 2, pt1))
# garden
pygame.draw.rect(DISPLAY, WHITE, (x+entw+pt1, y+ otsl + bedl + stal+dinl-pt1-2 , entdoor, pt1+pt2))
pygame.draw.rect(DISPLAY, Black, (x+entw+pt1, y+ otsl + bedl + stal+dinl-pt1-2 , 2, pt1+pt2-2))
pygame.draw.rect(DISPLAY, Black, (x+entw+pt1+entdoor, y+ otsl + bedl + stal+dinl-pt1-2 , 2, pt1+pt2-2))
