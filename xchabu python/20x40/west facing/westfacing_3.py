...
otsy1=y + otsl/2
pygame.draw.rect(DISPLAY, (0, 0,0), (x+toiw-1 , y , otsw1, otsl1), 2)
...
# ddrawing
pygame.draw.rect(DISPLAY, WHITE, (x + entw+pt1-4, y + toil + bedl + stal-2, roomdoor, pt1))
pygame.draw.rect(DISPLAY, Black, (x + entw+pt1-4, y + toil + bedl + stal-2, 2, pt1))
pygame.draw.rect(DISPLAY, Black, (x + entw+pt1-4+roomdoor, y + toil + bedl + stal-2, 2, pt1-2))
# entry
...
print("length of store ",stol/15)
print("Width of store",stow/15)
print("length of c toi ",col/15)
print("Width of c toi",cow/15)
while True:
