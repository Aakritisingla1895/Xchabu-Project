...
# dining to drawing
pygame.draw.rect(DISPLAY, WHITE, (x+entw -1+pt1+10, y+ otsl + bedl + stal-2 , roomdoor, pt1))
pygame.draw.rect(DISPLAY, Black, (x+entw -1+pt1+10, y+ otsl + bedl + stal-2 , 2, pt1))
pygame.draw.rect(DISPLAY, Black, (x+entw -1+pt1+10+roomdoor, y+ otsl + bedl + stal-2 , 2, pt1))
# garden
