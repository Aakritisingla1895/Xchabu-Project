...
pygame.draw.rect(DISPLAY, Black, (x+bedw+pt2+roomdoor, y+otsl, 2, pt2+2))
# kitchen
pygame.draw.rect(DISPLAY, WHITE, (x+bedw+pt2, y+otsl+kitl-2, roomdoor,pt1))
pygame.draw.rect(DISPLAY, Black, (x+bedw+pt2, y+otsl+kitl-2, 2,pt1-1))
pygame.draw.rect(DISPLAY, Black, (x+bedw+pt2+roomdoor, y+otsl+kitl-1, 2,pt1-2))
# ddrawing
