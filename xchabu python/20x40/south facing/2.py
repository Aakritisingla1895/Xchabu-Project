...
# inner utility
pygame.draw.rect(DISPLAY, (0, 0,0), (x+stow-1.5+pt2,y+pt1, utiw-pt2+1,util-pt1+1), 2)
#toilet:-
toil = len * 0.15
toiw = wid * 0.4
...
# inner toilet
pygame.draw.rect(DISPLAY, (0, 0,0), (x+stow+utiw+pt2-1.5 , y+pt1, toiw-pt2-pt1+1.5, toil-pt1+1), 2)
#kitchen:-
kitl = len * 0.275
kitw = wid * 0.45
kitx = x + kitw / 3
...
# utility
pygame.draw.rect(DISPLAY, WHITE, (x+stow-1+pt2,y+util-1, roomdoor-5,pt1))
pygame.draw.rect(DISPLAY,Black, (x+stow-2+pt2+roomdoor-5,y+util-1, 2,pt1))
pygame.draw.rect(DISPLAY,Black, (x+stow-2+pt2,y+util-1, 2,pt1-1))
# toilet
pygame.draw.rect(DISPLAY, WHITE, (x+stow+utiw-1.5+pt2, y+toil-1, toidoor, pt1))
pygame.draw.rect(DISPLAY, Black, (x+stow+utiw-1.5+pt2, y+toil-1, 2, pt1-1))
pygame.draw.rect(DISPLAY, Black, (x+stow+utiw-1.5+pt2+toidoor, y+toil-1, 2, pt1-1))
# kitchen
...
# dining
pygame.draw.rect(DISPLAY, WHITE, (x+kitw-2+pt1, y +toil-2+dinl, roomdoor, pt1))
pygame.draw.rect(DISPLAY, Black, (x+kitw-2+pt1, y +toil-2+dinl, 2, pt1))
pygame.draw.rect(DISPLAY, Black, (x+kitw-2+pt1+roomdoor, y +toil-2+dinl, 2, pt1))
# entry
