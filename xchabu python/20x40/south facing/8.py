...
# dining
pygame.draw.rect(DISPLAY, WHITE, (x+kitw-1+pt2, y+washl-2+dinl, roomdoor-20, pt1))
pygame.draw.rect(DISPLAY, Black, (x+kitw-1+pt2, y+washl-2+dinl, 2, pt1-2))
pygame.draw.rect(DISPLAY, Black, (x+kitw-1+pt2+roomdoor-20, y+washl-2+dinl, 2, pt1-2))
# toilet
pygame.draw.rect(DISPLAY, WHITE, (x+toiw-toidoor , y+toil-1, toidoor, pt1))
pygame.draw.rect(DISPLAY, Black, (x+toiw-toidoor-1 , y+toil-1, 2, pt1))
pygame.draw.rect(DISPLAY, Black, (x+toiw-1 , y+toil-1, 2, pt1-2))
# wash
