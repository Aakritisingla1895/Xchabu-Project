...
bed = font.render('Living Room', True, Black)
...
# wash
pygame.draw.rect(DISPLAY, WHITE, (x+stow-1+washw/2, y+washl-1 , roomdoor, pt1))
pygame.draw.rect(DISPLAY, Black, (x+stow-1+washw/2, y+washl-1 , 2, pt1-2))
pygame.draw.rect(DISPLAY, Black, (x+stow-1+washw/2+roomdoor, y+washl-1 , 2, pt1-2))
# bedroom
...
# kitchen
pygame.draw.rect(DISPLAY, WHITE, (x+bedw-1+pt2, y+stol +kitl-2, roomdoor-6, pt1))
