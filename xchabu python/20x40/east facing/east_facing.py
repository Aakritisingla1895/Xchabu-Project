...
# inner store
pygame.draw.rect(DISPLAY, (0, 0,0), (x + washw+pt2, y + util + bedl + stal - washl+pt2-50, stow-pt2, stol-pt2), 2)
# drawing room
dral = len * 0.4
draw = wid * 0.5
drawx = x + staw + draw / 3
...
# store
pygame.draw.rect(DISPLAY, WHITE, (x + utiw-pt1+23, y+toil-35, pt1, 33))
pygame.draw.rect(DISPLAY, Black, (x + utiw-pt1+23, y+toil-35, pt1, 3))
pygame.draw.rect(DISPLAY, Black, (x + utiw-pt1+23, y+toil-2, pt1, 3))
# c.toilet
pygame.draw.rect(DISPLAY, WHITE, (x + bedw++pt1+pt1+1, y + toil+col-pt1+3, toidoor, pt1))
pygame.draw.rect(DISPLAY, Black, (x + bedw++pt1+pt1+1+toidoor, y + toil+col-pt1+3, 2, pt1))
# kitchen
...
# entry
pygame.draw.rect(DISPLAY, WHITE, (x + kitw+2, y + util + bedl + stal-2, entdoor-4, pt1))
...
print("length of  utility",util/15)
print("Width of utility ",utiw/15)
print("length of stairs",stal/15)
print("Width of stairs",staw/15)
print("length of drawing",dral/15)
print("length of wash ",washl/15)
print("Width of wash ",washw/15)
