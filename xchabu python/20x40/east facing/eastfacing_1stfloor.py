...
ctoilet = font.render('Dress', True, Black)
...
otsw = wid * 0.15
otsx = x + otsw / 3-5
otsy = y + util + bedl + stal - otsl + otsl / 2-50
pygame.draw.rect(DISPLAY, (0, 0,0), (x, y + util + bedl + stal - otsl-50,otsw, otsl), 2)
wash = font.render('OTS', True, Black)
DISPLAY.blit(wash, (otsx, otsy))
# ots inner
pygame.draw.rect(DISPLAY, (0, 0,0), (x+pt1, y + util + bedl + stal - otsl+pt2-50, otsw-pt1+1, otsl-pt2-pt2), 2)
# toilet 2
stol = len * 0.125
stow = wid * 0.35
stox = x + otsw + stow / 3
stoy = y + util + bedl + stal - otsl + stol / 2-50
pygame.draw.rect(DISPLAY, (0, 0,0), (x + otsw, y + util + bedl + stal - otsl-50, stow, stol), 2)
wash = font.render('Toilet', True, Black)
DISPLAY.blit(wash, (stox, stoy))
# inner toilet
pygame.draw.rect(DISPLAY, (0, 0,0), (x + otsw+pt2, y + util + bedl + stal - otsl+pt2-50, stow-pt2-pt2, stol-pt2), 2)
# drawing room
dral = len * 0.4
draw = wid * 0.5
drawx = x + staw + draw / 3
...
pygame.draw.rect(DISPLAY, (0, 0,0), (x + staw, y + util + bedl, draw1, dral1), 2)
# bedroom
#bedroom:-
bedl1 = len * 0.35
bedw1 = wid * 0.5
...
# store
pygame.draw.rect(DISPLAY, WHITE, (x + otsw+pt1-2, y + util + bedl + stal - otsl-50+otsl-2, 40, pt1))
# bedroom
