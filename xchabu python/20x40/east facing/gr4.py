...
# innner wall
pygame.draw.rect(DISPLAY, (0, 0,0), (x+pt1, y + util + bedl, staw-pt1+1, stal-pt2-50), 2)
# wash area
washl = len * 0.125
washw = wid * 0.4
washx = x + washw / 3-15
...
wash = font.render('Wash Area', True, Black)
DISPLAY.blit(wash, (washx, washy))
# wash inner
pygame.draw.rect(DISPLAY, (0, 0,0), (x+pt1, y + util + bedl + stal - washl+pt2-50, washw-pt1-pt2, washl-pt2-pt2), 2)
...
# door way
# utility
pygame.draw.rect(DISPLAY, WHITE, (x+utiw-60,y+util-2, roomdoor,pt1))
pygame.draw.rect(DISPLAY, Black, (x+utiw-60,y+util-2, 3 ,pt1))
pygame.draw.rect(DISPLAY, Black, (x+utiw-15,y+util-2, 3 ,pt1))
# wash
pygame.draw.rect(DISPLAY, WHITE, (x+pt1+2, y + util + bedl + stal - washl-50+washl-pt2-2, 40, pt1))
pygame.draw.rect(DISPLAY, Black, (x+pt1, y + util + bedl + stal - washl-50+washl-pt2-2, 2, pt1))
pygame.draw.rect(DISPLAY, Black, (x+pt1+2+40, y + util + bedl + stal - washl-50+washl-pt2-2, 2, pt1))
# bedroom
pygame.draw.rect(DISPLAY, WHITE, (x+bedw-57, y + util+bedl-8, roomdoor, pt1))
pygame.draw.rect(DISPLAY, Black, (x+bedw-57, y + util+bedl-8, 2, pt1))
pygame.draw.rect(DISPLAY, Black, (x+bedw-57+roomdoor, y + util+bedl-8, 2, pt1))
# drawing
pygame.draw.rect(DISPLAY, WHITE, (x + staw+2, y + util + bedl+dral-pt1+3, roomdoor, pt1))
pygame.draw.rect(DISPLAY, Black, (x + staw+2+roomdoor, y + util + bedl+dral-pt1+3, 2, pt1))
# empty
pygame.draw.rect(DISPLAY, WHITE, (x+staw+2, y + util + bedl + stal-52, pt1+2, 47))
pygame.draw.rect(DISPLAY, WHITE, (x+staw-2, y + util + bedl + stal-48, pt1+2, 47))
# toilet
pygame.draw.rect(DISPLAY, WHITE, (x + bedw+22, y +col-pt1, 50, pt1+pt1))
pygame.draw.rect(DISPLAY, Black, (x + bedw+72, y +col-pt1+2, 2, pt1-2))
# kitchen
pygame.draw.rect(DISPLAY, WHITE, (x+pt1, y + util + bedl + stal-2, kitw-pt1-pt1, pt1))
pygame.draw.rect(DISPLAY, Black, (x+pt1, y + util + bedl + stal-2,2, pt1))
pygame.draw.rect(DISPLAY, Black, (x+pt1+ kitw-pt1-pt1-1, y + util + bedl + stal-1,2, pt1))
